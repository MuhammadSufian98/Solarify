...
const Renewable = () => {
  return (
    <div className="w-full min-h-screen text-white bg-blue-950 py-10">
      <div className="w-[80%] mx-auto flex flex-col gap-20">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
          ...
          <div className="flex flex-col gap-6 text-center lg:text-left lg:w-1/2">
            ...
            <div className="group inline-flex items-center w-fit bg-blue-400 text-white font-semibold text-lg rounded-full px-6 py-3 transition-all duration-300 hover:bg-white hover:text-blue-950 shadow-lg cursor-pointer">
          ...
          <div className="flex flex-col gap-8 lg:w-1/2">
            ...
            <div className="flex w-full flex-col md:flex-row gap-6">
              <div className="w-full ">
                <img
                  className="w-300 h-full object-cover rounded-xl shadow-lg"
              ...
              <div className="flex flex-col gap-4 border-t border-white pt-4">
                {CardData.map((item) => (
                  <div key={item.id} className="p-4 bg-blue-900 rounded-lg hover:bg-blue-800 transition duration-200">
                    <h1 className="text-xl text-blue-400 font-semibold mb-1">{item.heading}</h1>
                    <p className="text-white text-base leading-relaxed">{item.para}</p>
                  </div>
                ))}
              </div>
            </div>
