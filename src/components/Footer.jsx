...
=======
    <footer className="w-full   relative z-10 overflow-visible">
      {/* Black Banner Section */}
      <div className="absolute -top-90 left-1/2 z-50 -translate-x-1/2 bg-black h-100 text-white w-[90%] md:w-[70%] rounded-xl p-6 md:p-10 shadow-xl">
        <div className="relative">
          <div className="flex justify-between items-start gap-10 ">
            {/* Left Side Text */}
            <div className="max-w-md flex sm:flex-row flex-col  absolute top-0 z-10">
              <p className="text-lg mb-2 ">
                Do you have questions about our services or want to learn more
                about sustainable living?
              </p>
              <h1 className="text-[50px]  md:text-[80px] font-semibold leading-none pt-5">
                GET IN
              </h1>
            </div>
            ...
            <div className="flex flex-col absolute -bottom-80 right-0 items-start md:items-end z-10">
              <h1 className="text-[60px] md:text-[100px]  font-semibold leading-none">
                TOUCH
              </h1>
...
>>>>>>> bbc999a1aa2f85f1f066363261cfd11b567d839c
      </div>

      {/* Footer Content */}
      <div className="flex flex-col bg-gray-100 sm:flex-row w-[90%] mx-auto justify-between items-center px-4 pt-20 pb-20 space-y-6 sm:space-y-0">
        {/* Navigation Links */}
        ...
        <div className="flex flex-col items-center  pt-10 gap-4">
          <div className="flex gap-4">
            <span className="p-3 border border-gray-300 transition duration-300 cursor-pointer text-gray-700 text-xl hover:bg-gray-700 hover:text-white rounded-full">
              <FaTwitter />
            </span>
            <span className="p-3 border border-gray-300 transition duration-300 cursor-pointer text-gray-700 text-xl hover:bg-gray-700 hover:text-white rounded-full">
              <FaFacebookSquare />
