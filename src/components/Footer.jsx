      ...
      <div className="flex flex-col sm:flex-row w-[90%] mx-auto justify-between items-center px-4 py-8 space-y-6 sm:space-y-0">
        ...
        <nav className="w-full sm:w-auto">
          <ul className="grid grid-cols-2 sm:grid-cols-3 gap-3 text-sm sm:text-base font-semibold text-gray-700 text-center sm:text-left">
            <li>
              <Link to="/home" className="cursor-pointer hover:text-blue-600 transition">
                Home
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/service" className="cursor-pointer hover:text-blue-600 transition">
                Service
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/blog" className="cursor-pointer hover:text-blue-600 transition">
                Blog
              </Link>
            </li>
            <li>
              <Link to="/privacy" className="cursor-pointer hover:text-blue-600 transition">
                Privacy
              </Link>
            </li>
            <li>
              <Link to="/faq" className="cursor-pointer hover:text-blue-600 transition">
                FAQ
              </Link>
            </li>
            <li>
              <Link to="/404" className="cursor-pointer hover:text-blue-600 transition">
                Not Found 404
              </Link>
            </li>
          </ul>
